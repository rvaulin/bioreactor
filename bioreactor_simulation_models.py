...
def standard_first_order_model(substrate, culture, specific_growth_rate_func, specific_growth_rate_params,
                               decay_rate_func, decay_rate_params, model_params):
    """
...
def run_family_of_models(initial_substrate, initial_culture,
    ...
    for temperature in temperatures:
        ...
        (times, substrate_ts, culture_ts) = run_standard_first_order_model(standard_first_order_model,
        ...
        evolutions_vs_temperature[temperature] = (times, substrate_ts, culture_ts)
    ...
    for ph in phs:
        ...
        evolutions_vs_ph[ph] = (times, substrate_ts, culture_ts)
